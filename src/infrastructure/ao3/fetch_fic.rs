...
use std::error::Error;
use crate::domain::fic::{ArchiveWarnings, Categories, Fanfiction, Rating, ReadingStatus};

pub fn fetch_fanfiction(fic_id: u64, base_url: &str) -> Result<Fanfiction, Box<dyn Error>> {
